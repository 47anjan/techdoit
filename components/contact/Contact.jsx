        ...
        <div className="flex flex-col gap-5">
          <div>
            ...
            <div className="text-blue-gray space-y-1 text-lg">
              <div>PSD Building, 2 AlBahr St,</div>
              <div>Loskia sripur, jamukara.</div>
            </div>
          </div>
          <div>
            <h3 className="text-[26px] font-semibold from-navy-blue mb-3">
            ...
            <div className="text-blue-gray space-y-1 text-lg">
              <div>Telephone : 0029129102320</div>
              <div>Mobile : 000 2324 39493</div>
            </div>
          </div>
          <div>
            <h3 className="text-[26px] font-semibold from-navy-blue mb-3">
            ...
            <div className="text-blue-gray space-y-1 text-lg">
              <div>Main Email : name@website.com</div>
